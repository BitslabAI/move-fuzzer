module overmind::nftango {
    ...
    public fun assert_nftango_store_is_player(account_address: address, game_address: address)  {
    ...
    public entry fun play_game(account: &signer, did_creator_win: bool) {
        // TODO: run assert_nftango_store_exists
        // TODO: run assert_nftango_store_is_active
    ...
    public entry fun claim(account: &signer, game_address: address) {
        // TODO: run assert_nftango_store_exists
